...
export function ModalDetalleExamen({
  ...
  const cargarCalificacion = async () => {
    try {
      ...
      setNuevaNota(data.calificacion_examen.toString());
  ...
  const handleCancelar = () => {
    setNuevaNota(calificacion.calificacion_examen.toString());
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Detalle de Calificación - Examen Quimestral</DialogTitle>
          <DialogDescription>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {Number(calificacion.calificacion_examen).toFixed(2)}
                    </p>
                  </div>
                  <div>
